...
<?php
    ...
    if (isset($_POST['submit']))   // if button is submit
    {
        ...
        {
            $loginquery = "SELECT * FROM admin WHERE admin_email='$email' && admin_password='$pass'"; //selecting matching records
            ...
            if (is_array($row))  // if matching records in the array & if everything is right
            {
                ...
                $_SESSION["admin_email"] = $row['admin_email']; // put user id into temp session
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">LOGIN YOUR DTS ACCOUNT</h1>
                                        <?php echo $message ?>
                                    </div>
